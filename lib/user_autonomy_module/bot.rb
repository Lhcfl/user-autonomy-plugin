...
module ::UserAutonomyModule::Bot
  # def create_bot(id, admin: false, username: nil)
  ...
  class << self
    ...
    def botSendPost(topic_id, rawText, **opts)
      PostCreator.create!(
        getBot,
        topic_id: topic_id,
        raw: rawText,
